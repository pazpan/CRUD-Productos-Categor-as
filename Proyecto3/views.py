...
#Función de inicio que cuenta productos y categorías
def home(request):
     #Contar categorías y productos en la base de datos
    categorias_count = Categoria.objects.count()
    productos_count = Producto.objects.count()
    # Contexto para pasar a la pantalla 'home.html'
    context = {
        'categorias_count': categorias_count,
        'productos_count': productos_count
    }
    # Renderizar a la pagina home con el contexto
